...
export const projects: Project[] = [
  { className: "project--solar", index: 0, type: "BRANDING / TRAVEL", title: ["SOLAR", "ADVENTURES"], description: "Айдентика приключения, построенная на ярком маршруте, свободе и солнечном цвете.", image: solar, imageAlt: "SOLAR ADVENTURES — айдентика путешествий", detail: { description: "Система айдентики для путешествия, где маршрут собирается из живой типографики, солнечных полей и наблюдений в дороге.", images: [solarCaseOne, solarCaseTwo], tags: ["АЙДЕНТИКА", "ПУТЕШЕСТВИЯ", "PRINT"], behanceUrl: "https://www.behance.net/gallery/243499863/SOLAR-ADVENTURES" } },
  { className: "project--theatre", index: 1, type: "POSTER / CULTURE", title: ["Театральная", "пьеса"], image: theatre, imageAlt: "Плакат театральной пьесы", detail: { description: "Плакат для театральной пьесы: масштабный образ, напряжённый цвет и типографика, которая работает как часть сценического действия.", images: [theatreCase], tags: ["ПОСТЕР", "КУЛЬТУРА", "ТИПОГРАФИКА"], behanceUrl: "https://www.behance.net/pegasy" } },
