...
export type ProjectDetail = { description: string; images: string[]; tags: string[] };
export type Project = {
  className: string;
  index: number;
  type: string;
...
export const navigation = ["ОБО МНЕ", "РАБОТЫ", "КОНТАКТЫ"];
...
export const projects: Project[] = [
  { className: "project--solar", index: 0, type: "BRANDING / TRAVEL", title: ["SOLAR", "ADVENTURES"], description: "Айдентика приключения, построенная на ярком маршруте, свободе и солнечном цвете.", image: solar, imageAlt: "SOLAR ADVENTURES — айдентика путешествий", detail: { description: "Система айдентики для путешествия, где маршрут собирается из живой типографики, солнечных полей и наблюдений в дороге.", images: [solarCaseOne, solarCaseTwo], tags: ["АЙДЕНТИКА", "ПУТЕШЕСТВИЯ", "PRINT"] } },
